         ...
         <div class="collapse" id="gamerules">
            <ul class="list-group">
               ...
               <ul>
                  ...
                  <li class="list-group-item">3c. Guards may not come within close distance to any T's. The distance is approximately 5 player models away (Baiting) T's who attack violating CT's should be pardoned. Killing a T while baiting will result in a (slay/swap/ctban/kick/ban)</li>
                  </br>
               </ul>
               ...
               <ul>
                  ...
                  <li class="list-group-item">4d. Guards may only enter vents if they see a T go in the vent or by wardens permission. </li>
                  </br>
               </ul>
               ...
               <li class="list-group-item">11. Freeze is implied at the end of a command unless ordered otherwise</li>
               </br>
               ...
               <ul>
                  <li class="list-group-item">12a. T's who constantly ask to delay or troll are subject to (slay/silence/kick/ban)</li>
                  </br>
               </ul>
               ...
               <ul>
                  <li class="list-group-item">13a. Other Ct's may repeat for the warden if it is correct. Misinformation will result in a (slay/swap/ctban/kick/ban)</li>
                  </br>
               </ul>
               ...
               <ul>
                  ...
                  <li class="list-group-item">14d. The Final T may choose the Rebel option, where he may be killed as if he was a rebelling T.</li>
                  </br>
               </ul>
               ...
               <li class="list-group-item"><strong> *Definition* Baiting: When a CT is within knifing distance from where a T is supposed to be or in the path of where the T is supposed to be going.</strong></li>
               </br>
